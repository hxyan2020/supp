      ...
      {!hideHeader && (
        <div className="sticky top-0 z-30 px-4 pt-3">
          <header className="flex h-12 items-center justify-between rounded-2xl border border-white/10 bg-black/80 px-4 shadow-lg shadow-black/30 backdrop-blur-md">
            <Link
              href="/explore"
              className={`flex items-center gap-2 ${brandHand} text-[22px] font-semibold leading-none tracking-normal`}
            >
              <img
                src="/logo.jpg"
                alt=""
            ...
            <span
              className={`${brandHand} max-w-[58%] text-right text-[13px] leading-snug text-white/75 sm:text-[14px]`}
            >
              {tBrand("slogan")}
            </span>
          </header>
